...
template <class String, template <class, class> class Vector = std::vector >
  ...
  typedef Vector<response_header,
                 std::allocator<response_header>> headers_vector;
 ...
 private:
  ...
  static String to_string(status_type status) {
    ...
    static const char created[] = "<html>"
                                  "<head><title>Created</title></head>"
                                  "<body><h1>201 Created</h1></body>"
                                  "</html>";
    static const char accepted[] = "<html>"
                                   "<head><title>Accepted</title></head>"
                                   "<body><h1>202 Accepted</h1></body>"
                                   "</html>";
    static const char no_content[] = "<html>"
    ...
    static const char not_implemented[] =
        ...
        "</html>";
    static const char bad_gateway[] = "<html>"
