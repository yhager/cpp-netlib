...
#ifndef __BOOST_NETWORK_PROTOCOL_XMPP_ELEMENT_INC__
# define __BOOST_NETWORK_PROTOCOL_XMPP_ELEMENT_INC__


# include <boost/network/traits/string.hpp>
# include <boost/network/traits/headers_container.hpp>
# include <boost/network/protocol/xmpp/traits/element_children.hpp>
# include <boost/network/protocol/xmpp/traits/parser_backend.hpp>
